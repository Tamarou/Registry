...
CREATE TABLE registry.payments (
    ...
    error_message text,
    amount_cents integer DEFAULT 0 NOT NULL,
    refund_owed_cents integer DEFAULT 0 NOT NULL,
    refunded_cents integer DEFAULT 0 NOT NULL,
    refund_seq integer DEFAULT 0 NOT NULL,
    refund_increments jsonb DEFAULT '[]'::jsonb NOT NULL,
    CONSTRAINT payments_refund_increments_cents_integer CHECK ((NOT jsonb_path_exists(refund_increments, '$[*]."cents"?(@ != @.floor() || @.type() != "number")'::jsonpath))),
    CONSTRAINT payments_refund_increments_is_array CHECK ((jsonb_typeof(refund_increments) = 'array'::text)),
    CONSTRAINT payments_refund_owed_cents_check CHECK ((refund_owed_cents >= 0)),
    CONSTRAINT payments_refund_seq_check CHECK ((refund_seq >= 0)),
    CONSTRAINT payments_refund_total_check CHECK (((refund_owed_cents + refunded_cents) <= amount_cents)),
    CONSTRAINT payments_refunded_cents_check CHECK ((refunded_cents >= 0)),
    CONSTRAINT payments_status_check CHECK (((status)::text = ANY ((ARRAY['pending'::character varying, 'processing'::character varying, 'completed'::character varying, 'failed'::character varying, 'refund_pending'::character varying, 'refunded'::character varying, 'partially_refunded'::character varying])::text[])))
);
...
CREATE TABLE registry.tenants (
    ...
    CONSTRAINT tenants_slug_is_lowercase CHECK ((slug = lower(slug)))
);
...
--
-- Name: webhook_events; Type: TABLE; Schema: registry; Owner: postgres
--

CREATE TABLE registry.webhook_events (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    stripe_event_id text NOT NULL,
    event_type text,
...
ALTER TABLE registry.webhook_events OWNER TO postgres;
...
966936f2-69fe-4979-81d9-3e407523be5d	2026-09-24 12:11:54.973671+00	0	87730dc2-608f-4c91-a2eb-550a08efc86a	9db4b9f1-f892-435b-97ef-b1462c827f41	404c3400-9783-46f2-b6dc-a807e7c8aabc	\N	\N	2026-09-24 12:11:54.973671+00	2026-09-24 12:11:54.973671	\N	\N	999999	registration	published
\.
...
87730dc2-608f-4c91-a2eb-550a08efc86a	Online	online	{"type": "virtual"}	\N	\N	2026-09-24 12:11:54.963826+00	2026-09-24 12:11:54.963826	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N
\.
...
130ff343-b622-44db-80e1-8fa5a20b46dd	Program Announcement	Important Update: {{program_name}}	Dear {{parent_name}},\n\nWe have an important announcement regarding {{program_name}}.\n\n{{announcement_details}}\n\nIf you have any questions, please don't hesitate to contact us.\n\nBest regards,\n{{sender_name}}\n{{organization_name}}	announcement	program	{"parent_name": "Parent's name", "sender_name": "Staff member name", "program_name": "Name of the program", "organization_name": "Organization name", "announcement_details": "Details of the announcement"}	00000000-0000-0000-0000-000000000000	t	2026-09-24 12:11:46.409276+00	2026-09-24 12:11:46.409276+00
7525b792-fee3-4d17-aee3-dd96e90c4daf	Session Update	Session Update: {{session_name}}	Dear {{parent_name}},\n\nWe wanted to update you about {{session_name}} for {{child_name}}.\n\n{{update_details}}\n\nThank you for your understanding.\n\nBest regards,\n{{sender_name}}	update	session	{"child_name": "Child's name", "parent_name": "Parent's name", "sender_name": "Staff member name", "session_name": "Name of the session", "update_details": "Details of the update"}	00000000-0000-0000-0000-000000000000	t	2026-09-24 12:11:46.409276+00	2026-09-24 12:11:46.409276+00
4b8f3bae-e029-46d2-80e3-ddc6b8093e13	Emergency Alert	URGENT: {{emergency_title}}	Dear {{parent_name}},\n\nThis is an urgent message regarding {{scope_description}}.\n\n{{emergency_details}}\n\nPlease take immediate action as needed.\n\n{{contact_information}}\n\n{{sender_name}}\n{{organization_name}}	emergency	tenant-wide	{"parent_name": "Parent's name", "sender_name": "Staff member name", "emergency_title": "Title of emergency", "emergency_details": "Emergency details", "organization_name": "Organization name", "scope_description": "What the emergency affects", "contact_information": "Emergency contact info"}	00000000-0000-0000-0000-000000000000	t	2026-09-24 12:11:46.409276+00	2026-09-24 12:11:46.409276+00
\.
...
COPY registry.payments (id, user_id, currency, status, stripe_payment_intent_id, stripe_payment_method_id, metadata, created_at, updated_at, completed_at, error_message, amount_cents, refund_owed_cents, refunded_cents, refund_seq, refund_increments) FROM stdin;
\.
...
11f39d6d-4206-4ba3-83a7-3f29f1db3a07	\N	tenant	Registry Standard - $200/month	subscription	fixed	USD	f	\N	{}	{"includes": ["unlimited_programs", "unlimited_enrollments", "email_support"], "monthly_amount": 200.00}	{"default": true, "description": "Standard monthly subscription"}	2026-09-24 12:11:52.34891+00	2026-09-24 12:11:52.34891+00	20000
aa9f656a-726c-48a9-85f3-0c2a74d54760	\N	tenant	Registry Plus - $100/month + 1%	hybrid	hybrid	USD	f	\N	{}	{"applies_to": "customer_payments", "percentage": 0.01, "monthly_base": 100.00}	{"default": false, "description": "Reduced monthly fee with revenue share"}	2026-09-24 12:11:52.34891+00	2026-09-24 12:11:52.34891+00	10000
e2851fbc-96df-456b-978a-39ba8da231ae	\N	platform	Registry Free	standard	percentage	USD	f	\N	{}	{"applies_to": "customer_payments", "percentage": 0.00, "minimum_monthly": 0, "refund_application_fee": true}	{"default": true, "description": "Platform fallback: no revenue share"}	2026-09-24 12:12:00.107677+00	2026-09-24 12:12:00.107677+00	0
7311bcc2-25b6-42ed-9ed0-ce1b7e778b6e	\N	tenant	Solo	revenue_share	percentage	USD	f	\N	{}	{"applies_to": "customer_payments", "percentage": 0.025, "description": "Revenue share on customer payments. No monthly fee, no minimums.", "minimum_monthly": 0, "refund_application_fee": true}	{"default": false, "featured": true, "launch_rate": true, "display_order": 1}	2026-09-24 12:11:52.34891+00	2026-09-24 12:12:07.465636+00	0
1ae33e4d-5b08-4e66-8b99-34bd7f5bb19a	\N	tenant	Studio	standard	hybrid	USD	f	\N	{}	{"applies_to": "customer_payments", "percentage": 0.02, "description": "Everything in Solo, plus multi-location scheduling", "refund_application_fee": true}	{"coming_soon": true, "description": "Everything in Solo, plus multi-location scheduling", "seeded_tier": "Studio", "display_order": 2, "created_by_migration": "seed-tier-pricing-options"}	2026-09-24 12:12:07.465636+00	2026-09-24 12:12:07.465636+00	19900
946612a2-992f-462e-9858-30e0facf7ae3	\N	tenant	Empire	standard	hybrid	USD	f	\N	{}	{"applies_to": "customer_payments", "percentage": 0.01, "description": "Everything in Studio, plus priority support", "refund_application_fee": true}	{"coming_soon": true, "description": "Everything in Studio, plus priority support", "seeded_tier": "Empire", "display_order": 3, "created_by_migration": "seed-tier-pricing-options"}	2026-09-24 12:12:07.465636+00	2026-09-24 12:12:07.465636+00	99900
\.
...
36d0ee40-9e1f-4cda-ac9d-894fce509337	00000000-0000-0000-0000-000000000000	f7e6762f-c446-4db7-8088-108acbc0e23c	11f39d6d-4206-4ba3-83a7-3f29f1db3a07	suspended	{"plan_name": "Registry Standard - $200/month", "plan_type": "tenant_subscription", "created_by_migration": "create-default-pricing-relationships", "suspended_by_migration": "suspend-rateless-tenant-plans"}	2026-09-24 12:12:00.782672+00	2026-09-24 12:12:02.247821+00
cf992eca-6a00-4e08-8c68-3254be6d0228	00000000-0000-0000-0000-000000000000	f7e6762f-c446-4db7-8088-108acbc0e23c	aa9f656a-726c-48a9-85f3-0c2a74d54760	suspended	{"plan_name": "Registry Plus - $100/month + 1%", "plan_type": "tenant_subscription", "created_by_migration": "create-default-pricing-relationships", "suspended_by_migration": "retire-registry-plus-plan"}	2026-09-24 12:12:00.782672+00	2026-09-24 12:12:04.297281+00
f876d726-8ab9-46d7-8707-d593ffec8556	00000000-0000-0000-0000-000000000000	f7e6762f-c446-4db7-8088-108acbc0e23c	7311bcc2-25b6-42ed-9ed0-ce1b7e778b6e	active	{"plan_name": "Solo", "plan_type": "tenant_subscription", "created_by_migration": "create-default-pricing-relationships"}	2026-09-24 12:12:00.782672+00	2026-09-24 12:12:07.465636+00
492ff1b9-2970-4f77-b55e-f24b64483a38	00000000-0000-0000-0000-000000000000	f7e6762f-c446-4db7-8088-108acbc0e23c	1ae33e4d-5b08-4e66-8b99-34bd7f5bb19a	active	{"plan_name": "Studio", "plan_type": "tenant_subscription", "created_by_migration": "seed-tier-pricing-options"}	2026-09-24 12:12:07.465636+00	2026-09-24 12:12:07.465636+00
c739f05a-2dc8-45c0-9822-3e53c9bd698e	00000000-0000-0000-0000-000000000000	f7e6762f-c446-4db7-8088-108acbc0e23c	946612a2-992f-462e-9858-30e0facf7ae3	active	{"plan_name": "Empire", "plan_type": "tenant_subscription", "created_by_migration": "seed-tier-pricing-options"}	2026-09-24 12:12:07.465636+00	2026-09-24 12:12:07.465636+00
\.
...
c6c57ce1-fc72-458f-b6d9-dd54e47fd4e7	afterschool	After School Program	{"standard_times": {"friday": "15:00", "monday": "15:00", "tuesday": "15:00", "thursday": "15:00", "wednesday": "14:00"}, "session_pattern": "weekly_for_x_weeks", "enrollment_rules": {"same_session_for_siblings": true}}	2026-09-24 12:11:42.877752+00	2026-09-24 12:11:42.877752
b6362f24-901f-440d-a325-44246ce94de7	summer-camp	Summer Camp	{"standard_times": {"end": "15:00", "start": "09:00"}, "session_pattern": "daily_for_x_days", "enrollment_rules": {"same_session_for_siblings": false}}	2026-09-24 12:11:42.877752+00	2026-09-24 12:11:42.877752
\.
...
9db4b9f1-f892-435b-97ef-b1462c827f41	Tiny Art Empire	tiny-art-empire	{"registration_workflow": "tenant-signup"}	Start your own art education business. Create programs, manage enrollments, accept payments — all in one platform.	2026-09-24 12:11:54.966362+00	2026-09-24 12:11:54.966362	\N	draft
\.
...
14b62e16-1a7a-481e-9aad-f97a00ad15bd	3b2d55bd-5b3c-41f1-bfad-76d26ffcc118	966936f2-69fe-4979-81d9-3e407523be5d	2026-09-24 12:11:54.980106+00	2026-09-24 12:11:54.980106
\.
...
COPY registry.sessions (id, name, slug, metadata, notes, created_at, updated_at, session_type, start_date, end_date, status, capacity, waitlist_enabled) FROM stdin;
3b2d55bd-5b3c-41f1-bfad-76d26ffcc118	Get Started Today	get-started	\N	\N	2026-09-24 12:11:54.970112+00	2026-09-24 12:11:54.970112	regular	2026-09-24	2036-09-24	published	999999	t
\.
...
00000000-0000-0000-0000-000000000000	f7e6762f-c446-4db7-8088-108acbc0e23c	t	2026-09-24 12:12:00.782672+00
\.
...
158f2530-27bc-44fb-badc-00a2769814c6	Registry System	registry	2026-09-24 12:11:39.86815+00	\N	\N	trial	\N	\N	\N	24	\N	f	f	7311bcc2-25b6-42ed-9ed0-ce1b7e778b6e
00000000-0000-0000-0000-000000000000	Registry Platform	registry-platform	2026-09-24 12:11:52.34891+00	\N	\N	active	\N	\N	\N	24	\N	f	f	7311bcc2-25b6-42ed-9ed0-ce1b7e778b6e
\.
...
404c3400-9783-46f2-b6dc-a807e7c8aabc	system@tinyartempire.com	System	\N	\N	2026-09-24 12:11:54.96+00
f7e6762f-c446-4db7-8088-108acbc0e23c	admin@registry.platform	Platform Admin	\N	\N	2026-09-24 12:12:00.782672+00
\.
...
404c3400-9783-46f2-b6dc-a807e7c8aabc	system	nologin	2026-09-24 12:11:54.956459+00	\N	parent	\N	\N	f
f7e6762f-c446-4db7-8088-108acbc0e23c	platform_admin	$2b$12$DummyHashForSystemUser	2026-09-24 12:12:00.782672+00	\N	admin	\N	\N	f
\.
...
--
-- Data for Name: webhook_events; Type: TABLE DATA; Schema: registry; Owner: postgres
--

COPY registry.webhook_events (id, stripe_event_id, event_type, received_at, processed_at) FROM stdin;
\.
...
c9235c00bc368836d5323cd4b98cadfa673aa00e	a363697ff7f1f2ad0642dfc426f003e430fbb342	users	registry	initial creation of users table and basic schema etc	2026-09-24 12:11:38.779626+00	Chris Prather	chris.prather@tamarou.com	2024-05-13 17:21:58+00	Chris Prather	chris@prather.org
2960f6c6a1df94ef7f1c75a036db14aefe121bc5	978d2b0afaad7749217fc4bf998d858c91cb9e93	workflows	registry	add workflows\n\nWorkflows define a sequence of steps to be executed. We process each step and record the outcome in a workflow run.	2026-09-24 12:11:39.699131+00	Chris Prather	chris.prather@tamarou.com	2024-05-13 17:30:35+00	Chris Prather	chris@prather.org
2abd1a15dc06e9db731062527f8541e8c79ffb6f	24d73f7d6572fe110f256ca48b0a2a48dfafa96b	tenant-on-boarding	registry	create an onboarding workflow for tenants	2026-09-24 12:11:40.076878+00	Chris Prather	chris.prather@tamarou.com	2024-05-20 21:00:32+00	Chris Prather	chris@prather.org
2f7ae3c1f6f41d31425a9ba8fa21f2e73560115c	707b1c42fa45736727df395e145cbf439387c241	schema-based-multitennancy	registry	add the tools to do the schema-based multi-tenancy	2026-09-24 12:11:40.719746+00	Chris Prather	chris.prather@tamarou.com	2024-05-21 01:43:52+00	Chris Prather	chris@prather.org
5920ebcdc5fd6c9478af9fb1e435aedd26b5b5ce	3020bd64a1a510456cf157551ff7d475b0f916ef	events-and-sessions	registry	Add events and sessions to the system	2026-09-24 12:11:41.391317+00	Chris Prather	chris.prather@tamarou.com	2024-05-31 03:36:11+00	Chris Prather	chris.prather@tamarou.com
72bea40753b0250624322f67c9a64fe479f02df7	67a0442cd1589b353394cbd451cca098bb8e8634	edit-template-workflow	registry	default workflow for editing templates	2026-09-24 12:11:41.705605+00	Chris Prather	chris.prather@tamarou.com	2025-02-11 23:59:19+00	Chris Prather	chris.prather@tamarou.com
daf665c0e9b4b1255a0cf09bb88e322f6609b59f	db62b982c609c21307787f014f58577662cca0cd	outcomes	registry	add outcome definitions	2026-09-24 12:11:41.927023+00	Chris Prather	chris.prather@tamarou.com	2025-02-21 06:45:47+00	Chris Prather	chris.prather@tamarou.com
c0bb268a4a0c27a97351166c95d50a5f6d73d0ae	7d3e7133c01ac03e83020ba1578259ec444584cd	summer-camp-module	registry	add summer-camp-module	2026-09-24 12:11:42.33081+00	Chris Prather	chris.prather@tamarou.com	2025-02-22 04:38:37+00	Chris Prather	chris.prather@tamarou.com
6d1c676dccf7787d99a54edd3ec556193ff0562d	464a90d2ef6e7939e38fa2717439f3796e2f6936	fix-tenant-workflows	registry	Fix tenant workflows to include first_step	2026-09-24 12:11:42.641444+00	Chris Prather	chris.prather@tamarou.com	2025-03-22 18:57:13+00	Chris Prather	chris.prather@tamarou.com
4d1cce9dd15eadfe664b1a909c36f1afd6d943f2	7851550d6b87474630cd02469c9772024987ce32	program-types	registry	Add program types configuration system	2026-09-24 12:11:43.125307+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 12:00:00+00	Claude	noreply@anthropic.com
ac009951a991475b6b82050987874c5e1562b227	e79fc2deea1f57838d388bd3effc672f3d9de20b	enhanced-pricing-model	registry	Transform pricing to flexible pricing_plans with multiple tiers per session	2026-09-24 12:11:43.409308+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 12:30:00+00	Claude	noreply@anthropic.com
ca85da23e2f52eb6ef3b500530d301617d8d64d3	6e636122ad2b14731a616bee3fb8d06083559358	attendance-tracking	registry	Add attendance tracking infrastructure	2026-09-24 12:11:44.022786+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 13:00:00+00	Claude	noreply@anthropic.com
9478a08db15d08f6fae783493e14eb2348a478a4	1b0a9ae93451b1aad3fcad727c30430146b39669	waitlist-management	registry	Add waitlist functionality to enrollment system	2026-09-24 12:11:44.226468+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 13:30:00+00	Claude	noreply@anthropic.com
125881c219bfb9b9053e66b6b5fb5fdb720a1ee3	fa279aaea8c8f5c6fc0fc942ac69274ced15c1d4	add-program-type-to-projects	registry	Add program type reference to projects	2026-09-24 12:11:44.417804+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 14:00:00+00	Claude	noreply@anthropic.com
b935f44f3eace95edc2fa318ed7de32c27e8ac1a	b93b975d490c4384a02a3f8a66a48d99fd35a84b	add-user-fields-for-family	registry	Add birth_date, user_type, grade fields to users	2026-09-24 12:11:44.623079+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 14:25:00+00	Claude	noreply@anthropic.com
7deaa9fb9f8f3d0309d635af087792c28525f78e	189953a84a37895f33e367d8eb0fe3b647a2bfdf	multi-child-data-model	registry	Add family_members table for multi-child support	2026-09-24 12:11:44.844871+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 14:30:00+00	Claude	noreply@anthropic.com
815c14422aeab29c0c21415ea7e8927785a1c910	36fd27b0aff2c634ec86eb7662a0ecbc11d188e6	payments	registry	Add payments infrastructure for Stripe integration	2026-09-24 12:11:45.25249+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 19:00:00+00	Claude	noreply@anthropic.com
eee70c0e408183c5d818fa1a6ce7e3b34d3b7cf6	344a280c4b37d460e57e312c538aa0507dae53e1	add-payment-to-enrollments	registry	Add payment_id reference to enrollments table	2026-09-24 12:11:45.542119+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 19:15:00+00	Claude	noreply@anthropic.com
acd808bf85b5a9d8971f598186ced619196ffd0e	8cdbcbf5f5d6b5933c1027b75293e23c21f82f45	notifications-and-preferences	registry	Add notifications and user preferences for attendance tracking	2026-09-24 12:11:46.021071+00	Chris Prather	chris.prather@tamarou.com	2025-01-28 10:00:00+00	Claude	noreply@anthropic.com
5ce709b8eff5b3b920e7a675d78bee9dabd98367	9f6bfbd59ca138c524285ed7d9f0b7895354f801	parent-communication-system	registry	Add parent communication system with messages, recipients, and templates	2026-09-24 12:11:46.760232+00	Chris Prather	chris.prather@tamarou.com	2025-01-28 11:00:00+00	Claude	noreply@anthropic.com
fbe73787977942423bb4d7ba5dd152c0c1551e38	fea7e5a85e605358de32808abb27b09f7dd78e83	performance-optimization	registry	Add database indexes and performance optimizations for production readiness	2026-09-24 12:11:47.034496+00	Chris Prather	chris.prather@tamarou.com	2025-01-28 15:00:00+00	Claude	noreply@anthropic.com
d7d8aaecb2610865fd3801bb68ef57e474b29181	4a0067318476e1aa7150a0f54458884434cf9bfb	stripe-subscription-integration	registry	Add Stripe subscription integration for tenant billing	2026-09-24 12:11:47.214502+00	Chris Prather	chris.prather@tamarou.com	2025-01-28 16:00:00+00	Claude	noreply@anthropic.com
8eb88eeec3cb411430882061df8d5563af64ba1c	3fa34c99f03fa41b55239b2a0c7f393ba3d49bbf	fix-multi-child-enrollments	registry	Fix multi-child enrollment constraints for cleaner architecture	2026-09-24 12:11:47.400868+00	Chris Prather	chris.prather@tamarou.com	2025-07-15 00:34:24+00	Chris Prather	chris.prather@tamarou.com
4883848eccc158220c9e751882d20ae963d71f52	c4e3ea6ffbffc982060b0d165f60f0ff17bf78e7	flexible-enrollment-architecture	registry	Create flexible enrollment architecture supporting family, individual, group, and corporate students	2026-09-24 12:11:47.59282+00	Chris Prather	chris.prather@tamarou.com	2025-07-15 01:09:59+00	Chris Prather	chris.prather@tamarou.com
f6dbddd094284b0b7296c6e8258922882ae24b5d	b5baa9d2cf71178ed6fd3382231eb69d0b310cfd	remove-student-id-foreign-key	registry	Remove student_id foreign key constraint to support polymorphic student references	2026-09-24 12:11:47.764498+00	Chris Prather	chris.prather@tamarou.com	2025-07-15 01:28:59+00	Chris Prather	chris.prather@tamarou.com
ffe9a13ee38d1ffa2c706750718b34126adfe6e1	d2feca17971e5f93417b098a4295ff70ead570ee	fix-waitlist-family-member-refs	registry	Fix waitlist student_id to reference family_members instead of users	2026-09-24 12:11:47.962565+00	Chris Prather	chris.prather@tamarou.com	2025-07-16 14:30:00+00	Claude	noreply@anthropic.com
3c3d83d65febc9de2fbce70f02fa01b5483736e8	49be975f75b20172863921261abf3906bc100990	fix-waitlist-reorder	registry	Fix waitlist position reordering to avoid unique constraint violations	2026-09-24 12:11:48.507702+00	Chris Prather	chris.prather@tamarou.com	2025-07-16 12:30:00+00	Claude	noreply@anthropic.com
300e4d9f1d6bafe1b45f937ea482260f3313760d	b2b54846389dbdf3e2cf7ecbb15ae53fb4175d82	fix-waitlist-reorder-v2	registry	Improved waitlist position reordering to fully avoid constraint violations	2026-09-24 12:11:48.812812+00	Chris Prather	chris.prather@tamarou.com	2025-07-16 22:50:00+00	Claude	noreply@anthropic.com
0903ffab54af2242711b1cb470a44753acf6c9d7	695f0a352ff02e4b5f84381856fe538ac1badbb7	fix-waitlist-reorder-v3	registry	Remove problematic database trigger and handle position reordering in application code	2026-09-24 12:11:49.373625+00	Chris Prather	chris.prather@tamarou.com	2025-07-17 00:00:00+00	Claude	noreply@anthropic.com
acbd53f8d5ddfc205c3c1ca518ed92170803e32c	7b6df5319ffd75e81b5f3f06e95102a1df7f2e92	drop-transfer-business-rules	registry	Add drop and transfer business rules with admin approval workflow	2026-09-24 12:11:50.378991+00	Chris Prather	chris.prather@tamarou.com	2025-09-18 00:00:00+00	Claude	noreply@anthropic.com
41ae5ed8ebd0150b8a8c2987bdbfd98967252b18	4ca09b1d82b01de2a829979849fa4a7f4c3120d4	remove-waitlist-position-constraint	registry	Remove unique constraint on waitlist position to allow status-based visibility	2026-09-24 12:11:51.062008+00	Chris Prather	chris.prather@tamarou.com	2025-09-21 00:00:00+00	Claude	noreply@anthropic.com
788f8edbabafb05aef3b90f4b634beb1aaab7b8b	7dda1d870afb87ee03300b43bacf070e53c5c5ba	installment-payment-schedules	registry	Add payment schedules and scheduled payments for installment processing	2026-09-24 12:11:51.851537+00	Chris Prather	chris.prather@tamarou.com	2025-09-23 03:35:05+00	Chris Prather	chris.prather@tamarou.com
2fc34cc17316d64ee48ef1c04e4d9c5e096b29ba	e7ea8e7d72a0222c7493190abb060dd0767adb28	simplify-installment-schema-for-stripe	registry	Simplify database schema to use Stripe native scheduling and retry features	2026-09-24 12:11:52.200511+00	Chris Prather	chris.prather@tamarou.com	2025-09-24 18:00:00+00	Claude	noreply@anthropic.com
f61a99336db06d9d07bd30abcf6e18e98d7609ac	0f1e40107de5540b06f5181f72d75c6741728143	unified-pricing-infrastructure	registry	Add unified tenant-to-tenant pricing infrastructure	2026-09-24 12:11:52.61072+00	Chris Prather	chris.prather@tamarou.com	2025-09-29 00:44:03+00	Chris Prather	chris.prather@tamarou.com
eb5973974d4f4c06b6e5a93c84b5a66bfcd8f342	031717d9b7ea0651ef6b5f67942c8c978f502dbe	consolidate-pricing-relationships	registry	Consolidate pricing relationships into unified model	2026-09-24 12:11:52.993988+00	Chris Prather	chris.prather@tamarou.com	2025-09-29 16:07:15+00	Chris Prather	chris.prather@tamarou.com
20f187ed4e2e4c35404fcb5f7d48df933cebfcd5	6017815b229c39d2e9f7af54f1a963e3257a5bf2	pricing-relationship-events	registry	Add event sourcing for pricing relationship audit trail	2026-09-24 12:11:53.21927+00	Chris Prather	chris.prather@tamarou.com	2025-09-29 19:55:59+00	Chris Prather	chris.prather@tamarou.com
5f3d84a4d2158ce0ffcfeabc5772970faca7c3d3	f41063facc70f0ff67e7cc54de594af5b99d358b	remove-pricing-plan-relationship-fields	registry	Remove obsolete target_tenant_id and offering_tenant_id from pricing_plans	2026-09-24 12:11:53.425924+00	Chris Prather	chris.prather@tamarou.com	2025-09-29 22:27:51+00	Chris Prather	chris.prather@tamarou.com
a2248de7c1f81778ea19e6f9bc5c94e806e21268	5c6daf2fa1ab2205c6f0f0a0b153947e9304f3bd	passwordless-auth	registry	Passwordless auth: passkeys, magic links, API keys	2026-09-24 12:11:53.639697+00	Chris Prather	chris.prather@tamarou.com	2026-03-25 00:00:00+00	Chris Prather	chris.prather@tamarou.com
afdf73989587e92e423e0b5f643361890a90a860	bdd207b58bea14042c69ffad9efcc71e3cbfbcd7	auth-notification-types	registry	Add auth notification types to notification_type enum	2026-09-24 12:11:53.812041+00	Chris Prather	chris.prather@tamarou.com	2026-03-30 06:56:54+00	Chris Prather	chris.prather@tamarou.com
c0834addb5a970c41dc185be91f226cba562e013	314f27eca2ee77ce95e888776a12618b7d1bb0fc	tenant-domains	registry	Custom domain management for tenants	2026-09-24 12:11:54.015806+00	Chris Prather	chris.prather@tamarou.com	2026-03-30 19:04:42+00	Chris Prather	chris.prather@tamarou.com
5656344b5447eb9e8d5b274f18d9fbfffa20f8d4	aeab9e685093de23275127520d1387c90bff2e78	magic-link-verification	registry	Add verified_at column for two-step magic link flow	2026-09-24 12:11:54.352926+00	Chris Prather	chris.prather@tamarou.com	2026-03-31 12:11:05+00	Chris Prather	chris.prather@tamarou.com
c3c7ae6599f4db30315a79d7021519f29dafa31d	ca3c13270b018c747b12a06b702742a416a46a0e	waitlist-accepted-status	registry	Add accepted status to waitlist check constraint	2026-09-24 12:11:54.603735+00	Chris Prather	chris.prather@tamarou.com	2026-04-05 01:37:21+00	Chris Prather	chris.prather@tamarou.com
b1024a8fd0df88c3fd8a543fb5a09512b3fa1cfb	a54ac0d95185ebb088b7bc391c48cb9cfbfb792e	seed-registry-storefront	registry	Seed registry tenant storefront (empty stub, deployed to production)	2026-09-24 12:11:54.837964+00	Chris Prather	chris.prather@tamarou.com	2026-04-07 13:42:30+00	Chris Prather	chris.prather@tamarou.com
0d0c296e547099f9f75884c8283a0077920abc8c	70ca373942437f7f4629b935d4f21ac4b07c0c2e	seed-registry-storefront-v2	registry	Seed registry tenant storefront with actual data	2026-09-24 12:11:55.116408+00	Chris Prather	chris.prather@tamarou.com	2026-04-07 14:44:00+00	Chris Prather	chris.prather@tamarou.com
3c41efd35c15d993a9e2b9e7621c7f14de92649e	a27a8dd63d8941cf02199a86b6f9115998857b58	registry-landing-page-template	registry	Customize registry tenant landing page for Jordan's user journey	2026-09-24 12:11:56.128699+00	Chris Prather	chris.prather@tamarou.com	2026-04-11 00:00:00+00	Chris Prather	chris.prather@tamarou.com
730dfd28d76922a358dc3e5eaeb144725df7111e	526f15f28e63d0a77f4806b4d3b7aa513564d281	fix-utf8-mojibake	registry	Delete DB templates with mojibake so app reimports fixed versions	2026-09-24 12:11:56.326922+00	Chris Prather	chris.prather@tamarou.com	2026-04-11 12:00:00+00	Chris Prather	chris.prather@tamarou.com
4a34ed08664b5ae39f7caacd4f663285efb88267	819d7e62eb2165db006a8d41131c2cfaa0ab9f00	update-registry-landing-copy	registry	Update registry landing page copy and 3x2 card grid	2026-09-24 12:11:56.614567+00	Chris Prather	chris.prather@tamarou.com	2026-04-11 14:00:00+00	Chris Prather	chris.prather@tamarou.com
44c65bead55e0a35c5372aa2410a7fe5b3bf0e6b	83f48bc9c421c0e1cf1f0825a2e6a9498ca63e0d	program-publish-status	registry	Add status to projects and contact_person_id to locations for admin program setup	2026-09-24 12:11:56.899762+00	Chris Prather	chris.prather@tamarou.com	2026-04-19 00:00:00+00	Chris Prather	chris.prather@tamarou.com
c2d827c1542f2cf88b9769412919a1ee176147e7	3e1b6a2bee1de37a32150e01a522d5d6ed4caa09	enrollment-confirmation-notification-type	registry	Add enrollment_confirmation notification type	2026-09-24 12:11:57.366664+00	Chris Prather	chris.prather@tamarou.com	2026-04-23 00:00:00+00	Chris Prather	chris.prather@tamarou.com
d8dd117aea69688b601f189b8a05f2cc9975b897	8c6355a7f1a9332e26a6d5cc6b845776838157c7	webhook-event-dedup	registry	Track processed Stripe webhook event IDs for deduplication	2026-09-24 12:11:58.301683+00	Chris Prather	chris.prather@tamarou.com	2026-06-01 00:00:00+00	Chris Prather	chris.prather@tamarou.com
bfb052f4957649f0ccf5c59096ee321a100f2886	aa1d00cc663322063dd336e664e72e0f60d56910	enrollment-payment-dedup	registry	Unique index to make paid-enrollment finalization idempotent	2026-09-24 12:11:59.217308+00	Chris Prather	chris.prather@tamarou.com	2026-06-01 01:00:00+00	Chris Prather	chris.prather@tamarou.com
e9ff0519934e4fcea62f4734c5b9d3b20c09ef4c	8951d1778d26f1f372e59ee27de44183a0470533	fix-attendance-student-id-fkey	registry	Remove student_id FK from attendance_records to allow polymorphic family_member references	2026-09-24 12:11:59.414825+00	Chris Prather	chris.prather@tamarou.com	2026-06-08 00:00:00+00	Chris Prather	chris.prather@tamarou.com
3c299ff8324976d192be357e48699e64c975784f	5b0df8b63eb927e6f21cec635192008cda10414e	fix-clone-schema-identifier-quoting	registry	Quote dest_schema consistently with quote_ident in clone_schema to support reserved-word schema names	2026-09-24 12:11:59.606812+00	Chris Prather	chris.prather@tamarou.com	2026-06-10 00:00:00+00	Chris Prather	chris.prather@tamarou.com
3207dcbdd391a3113f62367a901b0319137093bc	4aa621090f6b0cab6de2d09acb81779587e32827	tenant-stripe-connect	registry	Add per-tenant Stripe Connect account and readiness flags for destination charges	2026-09-24 12:11:59.793466+00	Chris Prather	chris.prather@tamarou.com	2026-06-10 00:00:00+00	Chris Prather	chris.prather@tamarou.com
28e0bf2c6d92e23110f116d7ec4bd11d3a37c607	e1650770850473953cf5a6b823e1218eb79898a0	tenant-scoped-payments	registry	Move payment tables into tenant schemas and repoint enrollments.payment_id FK for tenant-local payment isolation	2026-09-24 12:12:00.003145+00	Chris Prather	chris.prather@tamarou.com	2026-06-10 00:00:00+00	Chris Prather	chris.prather@tamarou.com
28d74506683168469a7f47f7ba0500804400ebeb	2f7b7598efa787ec0a430cca91477d7261b9414f	seed-free-platform-plan	registry	Seed platform-scope Free (0%) fallback plan	2026-09-24 12:12:00.330997+00	Chris Prather	chris.prather@tamarou.com	2026-06-13 00:00:00+00	Chris Prather	chris.prather@tamarou.com
ab661862f6c5f4126610587fd3e7da46123c2f04	0660243596d8771fa9e2afcefbee446c73cf1cc6	create-default-pricing-relationships	registry	Create active platform relationships so tenant plans are selectable	2026-09-24 12:12:01.215789+00	Chris Prather	chris.prather@tamarou.com	2026-06-13 00:00:00+00	Chris Prather	chris.prather@tamarou.com
a3a7d4de067885cf24f3b965cee829661b4e7c63	155381d51a2aa54184c5a14f38a58449f288d20c	tenant-platform-pricing-plan	registry	Add tenants.platform_pricing_plan_id FK and backfill existing tenants	2026-09-24 12:12:01.852081+00	Chris Prather	chris.prather@tamarou.com	2026-06-16 00:00:00+00	Chris Prather	chris.prather@tamarou.com
4f5c0e1ad6352f2a79bd35ab6532bea463f381dc	742ee7a544d54b7c6d9052e7ffbf2fe7022b38dd	refund-application-fee-config	registry	Declare refund_application_fee on seeded platform + tenant plans	2026-09-24 12:12:02.12917+00	Chris Prather	chris.prather@tamarou.com	2026-07-03 23:09:47+00	Chris Prather	chris.prather@tamarou.com
f2e5326eff1970535911be0d1222e035d521c000	82e0ce0ff7efe488352cae133cbe6d6f7725993d	suspend-rateless-tenant-plans	registry	Stop offering tenant plans with no resolvable revenue-share rate	2026-09-24 12:12:02.357602+00	Chris Prather	chris.prather@tamarou.com	2026-08-03 23:18:43+00	Chris Prather	chris.prather@tamarou.com
0efcbdec112780d02871150d379f0e2b07264241	41842368d11c145c5430b6507668c56cb17014b7	pricing-plans-amount-cents	registry	Store pricing_plans money as integer cents; the rate lives only in pricing_configuration	2026-09-24 12:12:02.576735+00	Chris Prather	chris.prather@tamarou.com	2026-08-06 00:00:00+00	Chris Prather	chris.prather@tamarou.com
d685f3eb74071b32ce295c7722ef57a33c66f5d5	bf42fde8d39cdadb38af50afa9b589bd1e036804	payments-amount-cents	registry	Store payments and payment_items money as integer cents	2026-09-24 12:12:02.812166+00	Chris Prather	chris.prather@tamarou.com	2026-08-06 12:00:00+00	Chris Prather	chris.prather@tamarou.com
723b2c3e0164207d1f004b5584857c3f892cb0cc	0e5f13b006f2d71bff25eca81cecded06fe708b0	schedule-amounts-cents	registry	Store installment schedule money as integer cents	2026-09-24 12:12:03.00512+00	Chris Prather	chris.prather@tamarou.com	2026-08-06 13:00:00+00	Chris Prather	chris.prather@tamarou.com
7299cb40a004b6904fadeecd2da45cb01f18da03	892f9c723523cda0a17dcb6f9fa3bfa143a12d87	refund-amounts-cents	registry	Store refund money as integer cents	2026-09-24 12:12:03.309942+00	Chris Prather	chris.prather@tamarou.com	2026-08-06 14:00:00+00	Chris Prather	chris.prather@tamarou.com
1e944e76794f6455bcc241ac32a0cf7ad80786f0	483666918399420d0bbfee4a43e8deb77d5252f2	drop-installment-schedules	registry	Drop the installment schedule tables from registry and every tenant schema	2026-09-24 12:12:03.887312+00	Chris Prather	chris.prather@tamarou.com	2026-08-13 13:50:16+00	Chris Prather	chris.prather@tamarou.com
124e93eb6de0fd73c5506f9d21d246c748f42f60	9591878e59201ab231ca064b0d779101c4a73e91	retire-registry-plus-plan	registry	Stop offering the seeded Registry Plus hybrid plan	2026-09-24 12:12:04.817368+00	Chris Prather	chris.prather@tamarou.com	2026-08-13 14:37:13+00	Chris Prather	chris.prather@tamarou.com
51493d6426abe6800146664a09dd14c4845ef24c	4fabd2002bc65abf6f175b4f55da593797e00fb6	webhook-events-processed-at	registry	Add processed_at to registry.webhook_events for received-to-processed latency	2026-09-24 12:12:05.619765+00	Chris Prather	chris.prather@tamarou.com	2026-08-15 14:37:28+00	Chris Prather	chris.prather@tamarou.com
38dbe5f9ef7655079f93ab63a547b6ae7ea6c022	a6066943256c26ecb505ae52cc54919030e8534d	payments-typed-obligation	registry	Typed columns for the capacity-refund obligation, and a CHECK on payments.status	2026-09-24 12:12:06.155612+00	Chris Prather	chris.prather@tamarou.com	2026-08-22 23:30:00+00	Chris Prather	chris.prather@tamarou.com
cd225459045762634487962815fd105ace1caf30	d693d33b9dab7f8231ffe47cb365268b54d159ef	enrollment-reenrol-after-drop	registry	A cancelled enrollment stops occupying its seat, so a dropped child can re-join	2026-09-24 12:12:06.867452+00	Chris Prather	chris.prather@tamarou.com	2026-08-26 22:00:00+00	Chris Prather	chris.prather@tamarou.com
4f4968a7059d18a3163416e0754cd69981058282	9924e24152ed3c4b860e21f4cadb23f5d91d8e35	set-launch-revenue-share-rate	registry	Move the offered revenue-share plan to the launch rate and mark it as the launch plan	2026-09-24 12:12:07.298344+00	Chris Prather	chris.prather@tamarou.com	2026-09-04 14:50:00+00	Chris Prather	chris.prather@tamarou.com
49f1934e333630282a31ceaf6eeb71898b27d9c5	e6fb13e011417f470d6d4ee424ba9bfb6ddf0fa5	seed-tier-pricing-options	registry	Put the Solo/Studio/Empire tier model into the plans the signup page renders	2026-09-24 12:12:07.670214+00	Chris Prather	chris.prather@tamarou.com	2026-09-04 16:05:00+00	Chris Prather	chris.prather@tamarou.com
0f7d16835c8b41ad227ab66d68c36003de68fc21	19f7d9dbbb4d29ecfc81ee77d521b8b57f801d5f	clear-template-import-stamps	registry	Drop stamps computed from bytes so the fixed character-based import re-stamps every row	2026-09-24 12:12:07.970661+00	Chris Prather	chris.prather@tamarou.com	2026-09-13 21:15:00+00	Chris Prather	chris.prather@tamarou.com
20680f8b72d460b535289c226047d46b15a1a499	168162a565c0683a207bd496b7098582d120d22b	tenant-slug-lowercase	registry	Tenant slugs must be lowercase: clone_schema case-folds an unquoted dest_schema	2026-09-24 12:12:08.246512+00	Chris Prather	chris.prather@tamarou.com	2026-09-14 04:05:00+00	Chris Prather	chris.prather@tamarou.com
a7040f956947ab1eaa9b1eb52dac77c768d24082	b954ff9b2c773c4b94766e46b4c7867c62fb2ab6	session-waitlist-toggle	registry	A session can turn its waitlist off, so a full one is simply full	2026-09-24 12:12:08.508073+00	Chris Prather	chris.prather@tamarou.com	2026-09-24 12:10:00+00	Chris Prather	chris.prather@tamarou.com
\.
...
c2d827c1542f2cf88b9769412919a1ee176147e7	require	auth-notification-types	afdf73989587e92e423e0b5f643361890a90a860
d8dd117aea69688b601f189b8a05f2cc9975b897	require	payments	815c14422aeab29c0c21415ea7e8927785a1c910
bfb052f4957649f0ccf5c59096ee321a100f2886	require	add-payment-to-enrollments	eee70c0e408183c5d818fa1a6ce7e3b34d3b7cf6
e9ff0519934e4fcea62f4734c5b9d3b20c09ef4c	require	attendance-tracking	ca85da23e2f52eb6ef3b500530d301617d8d64d3
3c299ff8324976d192be357e48699e64c975784f	require	schema-based-multitennancy	2f7ae3c1f6f41d31425a9ba8fa21f2e73560115c
3207dcbdd391a3113f62367a901b0319137093bc	require	stripe-subscription-integration	d7d8aaecb2610865fd3801bb68ef57e474b29181
28e0bf2c6d92e23110f116d7ec4bd11d3a37c607	require	payments	815c14422aeab29c0c21415ea7e8927785a1c910
28e0bf2c6d92e23110f116d7ec4bd11d3a37c607	require	installment-payment-schedules	788f8edbabafb05aef3b90f4b634beb1aaab7b8b
28e0bf2c6d92e23110f116d7ec4bd11d3a37c607	require	add-payment-to-enrollments	eee70c0e408183c5d818fa1a6ce7e3b34d3b7cf6
28e0bf2c6d92e23110f116d7ec4bd11d3a37c607	require	enrollment-payment-dedup	bfb052f4957649f0ccf5c59096ee321a100f2886
28e0bf2c6d92e23110f116d7ec4bd11d3a37c607	require	tenant-stripe-connect	3207dcbdd391a3113f62367a901b0319137093bc
28d74506683168469a7f47f7ba0500804400ebeb	require	unified-pricing-infrastructure	f61a99336db06d9d07bd30abcf6e18e98d7609ac
ab661862f6c5f4126610587fd3e7da46123c2f04	require	remove-pricing-plan-relationship-fields	5f3d84a4d2158ce0ffcfeabc5772970faca7c3d3
ab661862f6c5f4126610587fd3e7da46123c2f04	require	unified-pricing-infrastructure	f61a99336db06d9d07bd30abcf6e18e98d7609ac
ab661862f6c5f4126610587fd3e7da46123c2f04	require	seed-free-platform-plan	28d74506683168469a7f47f7ba0500804400ebeb
a3a7d4de067885cf24f3b965cee829661b4e7c63	require	create-default-pricing-relationships	ab661862f6c5f4126610587fd3e7da46123c2f04
...
1e944e76794f6455bcc241ac32a0cf7ad80786f0	require	schedule-amounts-cents	723b2c3e0164207d1f004b5584857c3f892cb0cc
1e944e76794f6455bcc241ac32a0cf7ad80786f0	require	tenant-scoped-payments	28e0bf2c6d92e23110f116d7ec4bd11d3a37c607
124e93eb6de0fd73c5506f9d21d246c748f42f60	require	suspend-rateless-tenant-plans	f2e5326eff1970535911be0d1222e035d521c000
51493d6426abe6800146664a09dd14c4845ef24c	require	webhook-event-dedup	d8dd117aea69688b601f189b8a05f2cc9975b897
38dbe5f9ef7655079f93ab63a547b6ae7ea6c022	require	refund-amounts-cents	7299cb40a004b6904fadeecd2da45cb01f18da03
cd225459045762634487962815fd105ace1caf30	require	flexible-enrollment-architecture	4883848eccc158220c9e751882d20ae963d71f52
4f4968a7059d18a3163416e0754cd69981058282	require	retire-registry-plus-plan	124e93eb6de0fd73c5506f9d21d246c748f42f60
49f1934e333630282a31ceaf6eeb71898b27d9c5	require	set-launch-revenue-share-rate	4f4968a7059d18a3163416e0754cd69981058282
0f7d16835c8b41ad227ab66d68c36003de68fc21	require	seed-tier-pricing-options	49f1934e333630282a31ceaf6eeb71898b27d9c5
20680f8b72d460b535289c226047d46b15a1a499	require	clear-template-import-stamps	0f7d16835c8b41ad227ab66d68c36003de68fc21
a7040f956947ab1eaa9b1eb52dac77c768d24082	require	tenant-slug-lowercase	20680f8b72d460b535289c226047d46b15a1a499
\.
...
deploy	c9235c00bc368836d5323cd4b98cadfa673aa00e	users	registry	initial creation of users table and basic schema etc	{}	{}	{}	2026-09-24 12:11:38.78991+00	Chris Prather	chris.prather@tamarou.com	2024-05-13 17:21:58+00	Chris Prather	chris@prather.org
deploy	2960f6c6a1df94ef7f1c75a036db14aefe121bc5	workflows	registry	add workflows\n\nWorkflows define a sequence of steps to be executed. We process each step and record the outcome in a workflow run.	{users}	{}	{}	2026-09-24 12:11:39.705937+00	Chris Prather	chris.prather@tamarou.com	2024-05-13 17:30:35+00	Chris Prather	chris@prather.org
deploy	2abd1a15dc06e9db731062527f8541e8c79ffb6f	tenant-on-boarding	registry	create an onboarding workflow for tenants	{workflows,users}	{}	{}	2026-09-24 12:11:40.082186+00	Chris Prather	chris.prather@tamarou.com	2024-05-20 21:00:32+00	Chris Prather	chris@prather.org
deploy	2f7ae3c1f6f41d31425a9ba8fa21f2e73560115c	schema-based-multitennancy	registry	add the tools to do the schema-based multi-tenancy	{tenant-on-boarding}	{}	{}	2026-09-24 12:11:40.724034+00	Chris Prather	chris.prather@tamarou.com	2024-05-21 01:43:52+00	Chris Prather	chris@prather.org
deploy	5920ebcdc5fd6c9478af9fb1e435aedd26b5b5ce	events-and-sessions	registry	Add events and sessions to the system	{schema-based-multitennancy}	{}	{}	2026-09-24 12:11:41.394083+00	Chris Prather	chris.prather@tamarou.com	2024-05-31 03:36:11+00	Chris Prather	chris.prather@tamarou.com
deploy	72bea40753b0250624322f67c9a64fe479f02df7	edit-template-workflow	registry	default workflow for editing templates	{}	{}	{}	2026-09-24 12:11:41.707583+00	Chris Prather	chris.prather@tamarou.com	2025-02-11 23:59:19+00	Chris Prather	chris.prather@tamarou.com
deploy	daf665c0e9b4b1255a0cf09bb88e322f6609b59f	outcomes	registry	add outcome definitions	{}	{}	{}	2026-09-24 12:11:41.930346+00	Chris Prather	chris.prather@tamarou.com	2025-02-21 06:45:47+00	Chris Prather	chris.prather@tamarou.com
deploy	c0bb268a4a0c27a97351166c95d50a5f6d73d0ae	summer-camp-module	registry	add summer-camp-module	{}	{}	{}	2026-09-24 12:11:42.334508+00	Chris Prather	chris.prather@tamarou.com	2025-02-22 04:38:37+00	Chris Prather	chris.prather@tamarou.com
deploy	6d1c676dccf7787d99a54edd3ec556193ff0562d	fix-tenant-workflows	registry	Fix tenant workflows to include first_step	{schema-based-multitennancy}	{}	{}	2026-09-24 12:11:42.647055+00	Chris Prather	chris.prather@tamarou.com	2025-03-22 18:57:13+00	Chris Prather	chris.prather@tamarou.com
deploy	4d1cce9dd15eadfe664b1a909c36f1afd6d943f2	program-types	registry	Add program types configuration system	{schema-based-multitennancy}	{}	{}	2026-09-24 12:11:43.129559+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 12:00:00+00	Claude	noreply@anthropic.com
deploy	ac009951a991475b6b82050987874c5e1562b227	enhanced-pricing-model	registry	Transform pricing to flexible pricing_plans with multiple tiers per session	{summer-camp-module}	{}	{}	2026-09-24 12:11:43.413608+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 12:30:00+00	Claude	noreply@anthropic.com
deploy	ca85da23e2f52eb6ef3b500530d301617d8d64d3	attendance-tracking	registry	Add attendance tracking infrastructure	{summer-camp-module,program-types}	{}	{}	2026-09-24 12:11:44.024913+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 13:00:00+00	Claude	noreply@anthropic.com
deploy	9478a08db15d08f6fae783493e14eb2348a478a4	waitlist-management	registry	Add waitlist functionality to enrollment system	{summer-camp-module,program-types}	{}	{}	2026-09-24 12:11:44.229009+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 13:30:00+00	Claude	noreply@anthropic.com
deploy	125881c219bfb9b9053e66b6b5fb5fdb720a1ee3	add-program-type-to-projects	registry	Add program type reference to projects	{program-types}	{}	{}	2026-09-24 12:11:44.4199+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 14:00:00+00	Claude	noreply@anthropic.com
deploy	b935f44f3eace95edc2fa318ed7de32c27e8ac1a	add-user-fields-for-family	registry	Add birth_date, user_type, grade fields to users	{users}	{}	{}	2026-09-24 12:11:44.625492+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 14:25:00+00	Claude	noreply@anthropic.com
deploy	7deaa9fb9f8f3d0309d635af087792c28525f78e	multi-child-data-model	registry	Add family_members table for multi-child support	{summer-camp-module,add-user-fields-for-family,program-types}	{}	{}	2026-09-24 12:11:44.848483+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 14:30:00+00	Claude	noreply@anthropic.com
deploy	815c14422aeab29c0c21415ea7e8927785a1c910	payments	registry	Add payments infrastructure for Stripe integration	{schema-based-multitennancy}	{}	{}	2026-09-24 12:11:45.257047+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 19:00:00+00	Claude	noreply@anthropic.com
deploy	eee70c0e408183c5d818fa1a6ce7e3b34d3b7cf6	add-payment-to-enrollments	registry	Add payment_id reference to enrollments table	{payments,summer-camp-module}	{}	{}	2026-09-24 12:11:45.546731+00	Chris Prather	chris.prather@tamarou.com	2025-01-27 19:15:00+00	Claude	noreply@anthropic.com
deploy	acd808bf85b5a9d8971f598186ced619196ffd0e	notifications-and-preferences	registry	Add notifications and user preferences for attendance tracking	{attendance-tracking}	{}	{}	2026-09-24 12:11:46.026629+00	Chris Prather	chris.prather@tamarou.com	2025-01-28 10:00:00+00	Claude	noreply@anthropic.com
deploy	5ce709b8eff5b3b920e7a675d78bee9dabd98367	parent-communication-system	registry	Add parent communication system with messages, recipients, and templates	{notifications-and-preferences}	{}	{}	2026-09-24 12:11:46.764303+00	Chris Prather	chris.prather@tamarou.com	2025-01-28 11:00:00+00	Claude	noreply@anthropic.com
deploy	fbe73787977942423bb4d7ba5dd152c0c1551e38	performance-optimization	registry	Add database indexes and performance optimizations for production readiness	{parent-communication-system}	{}	{}	2026-09-24 12:11:47.0362+00	Chris Prather	chris.prather@tamarou.com	2025-01-28 15:00:00+00	Claude	noreply@anthropic.com
deploy	d7d8aaecb2610865fd3801bb68ef57e474b29181	stripe-subscription-integration	registry	Add Stripe subscription integration for tenant billing	{enhanced-pricing-model}	{}	{}	2026-09-24 12:11:47.216353+00	Chris Prather	chris.prather@tamarou.com	2025-01-28 16:00:00+00	Claude	noreply@anthropic.com
deploy	8eb88eeec3cb411430882061df8d5563af64ba1c	fix-multi-child-enrollments	registry	Fix multi-child enrollment constraints for cleaner architecture	{multi-child-data-model}	{}	{}	2026-09-24 12:11:47.402743+00	Chris Prather	chris.prather@tamarou.com	2025-07-15 00:34:24+00	Chris Prather	chris.prather@tamarou.com
deploy	4883848eccc158220c9e751882d20ae963d71f52	flexible-enrollment-architecture	registry	Create flexible enrollment architecture supporting family, individual, group, and corporate students	{fix-multi-child-enrollments}	{}	{}	2026-09-24 12:11:47.594829+00	Chris Prather	chris.prather@tamarou.com	2025-07-15 01:09:59+00	Chris Prather	chris.prather@tamarou.com
deploy	f6dbddd094284b0b7296c6e8258922882ae24b5d	remove-student-id-foreign-key	registry	Remove student_id foreign key constraint to support polymorphic student references	{flexible-enrollment-architecture}	{}	{}	2026-09-24 12:11:47.766691+00	Chris Prather	chris.prather@tamarou.com	2025-07-15 01:28:59+00	Chris Prather	chris.prather@tamarou.com
deploy	ffe9a13ee38d1ffa2c706750718b34126adfe6e1	fix-waitlist-family-member-refs	registry	Fix waitlist student_id to reference family_members instead of users	{remove-student-id-foreign-key}	{}	{}	2026-09-24 12:11:47.966463+00	Chris Prather	chris.prather@tamarou.com	2025-07-16 14:30:00+00	Claude	noreply@anthropic.com
deploy	3c3d83d65febc9de2fbce70f02fa01b5483736e8	fix-waitlist-reorder	registry	Fix waitlist position reordering to avoid unique constraint violations	{waitlist-management}	{}	{}	2026-09-24 12:11:48.511385+00	Chris Prather	chris.prather@tamarou.com	2025-07-16 12:30:00+00	Claude	noreply@anthropic.com
deploy	300e4d9f1d6bafe1b45f937ea482260f3313760d	fix-waitlist-reorder-v2	registry	Improved waitlist position reordering to fully avoid constraint violations	{fix-waitlist-reorder}	{}	{}	2026-09-24 12:11:48.818197+00	Chris Prather	chris.prather@tamarou.com	2025-07-16 22:50:00+00	Claude	noreply@anthropic.com
deploy	0903ffab54af2242711b1cb470a44753acf6c9d7	fix-waitlist-reorder-v3	registry	Remove problematic database trigger and handle position reordering in application code	{fix-waitlist-reorder-v2}	{}	{}	2026-09-24 12:11:49.385828+00	Chris Prather	chris.prather@tamarou.com	2025-07-17 00:00:00+00	Claude	noreply@anthropic.com
deploy	acbd53f8d5ddfc205c3c1ca518ed92170803e32c	drop-transfer-business-rules	registry	Add drop and transfer business rules with admin approval workflow	{fix-multi-child-enrollments}	{}	{}	2026-09-24 12:11:50.3852+00	Chris Prather	chris.prather@tamarou.com	2025-09-18 00:00:00+00	Claude	noreply@anthropic.com
deploy	41ae5ed8ebd0150b8a8c2987bdbfd98967252b18	remove-waitlist-position-constraint	registry	Remove unique constraint on waitlist position to allow status-based visibility	{fix-waitlist-reorder-v3}	{}	{}	2026-09-24 12:11:51.067572+00	Chris Prather	chris.prather@tamarou.com	2025-09-21 00:00:00+00	Claude	noreply@anthropic.com
deploy	788f8edbabafb05aef3b90f4b634beb1aaab7b8b	installment-payment-schedules	registry	Add payment schedules and scheduled payments for installment processing	{payments}	{}	{}	2026-09-24 12:11:51.857203+00	Chris Prather	chris.prather@tamarou.com	2025-09-23 03:35:05+00	Chris Prather	chris.prather@tamarou.com
deploy	2fc34cc17316d64ee48ef1c04e4d9c5e096b29ba	simplify-installment-schema-for-stripe	registry	Simplify database schema to use Stripe native scheduling and retry features	{installment-payment-schedules}	{}	{}	2026-09-24 12:11:52.205442+00	Chris Prather	chris.prather@tamarou.com	2025-09-24 18:00:00+00	Claude	noreply@anthropic.com
deploy	f61a99336db06d9d07bd30abcf6e18e98d7609ac	unified-pricing-infrastructure	registry	Add unified tenant-to-tenant pricing infrastructure	{}	{}	{}	2026-09-24 12:11:52.614833+00	Chris Prather	chris.prather@tamarou.com	2025-09-29 00:44:03+00	Chris Prather	chris.prather@tamarou.com
deploy	eb5973974d4f4c06b6e5a93c84b5a66bfcd8f342	consolidate-pricing-relationships	registry	Consolidate pricing relationships into unified model	{unified-pricing-infrastructure}	{}	{}	2026-09-24 12:11:52.996315+00	Chris Prather	chris.prather@tamarou.com	2025-09-29 16:07:15+00	Chris Prather	chris.prather@tamarou.com
deploy	20f187ed4e2e4c35404fcb5f7d48df933cebfcd5	pricing-relationship-events	registry	Add event sourcing for pricing relationship audit trail	{consolidate-pricing-relationships}	{}	{}	2026-09-24 12:11:53.221062+00	Chris Prather	chris.prather@tamarou.com	2025-09-29 19:55:59+00	Chris Prather	chris.prather@tamarou.com
deploy	5f3d84a4d2158ce0ffcfeabc5772970faca7c3d3	remove-pricing-plan-relationship-fields	registry	Remove obsolete target_tenant_id and offering_tenant_id from pricing_plans	{}	{}	{}	2026-09-24 12:11:53.427241+00	Chris Prather	chris.prather@tamarou.com	2025-09-29 22:27:51+00	Chris Prather	chris.prather@tamarou.com
deploy	a2248de7c1f81778ea19e6f9bc5c94e806e21268	passwordless-auth	registry	Passwordless auth: passkeys, magic links, API keys	{users,schema-based-multitennancy}	{}	{}	2026-09-24 12:11:53.641841+00	Chris Prather	chris.prather@tamarou.com	2026-03-25 00:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	afdf73989587e92e423e0b5f643361890a90a860	auth-notification-types	registry	Add auth notification types to notification_type enum	{notifications-and-preferences,passwordless-auth}	{}	{}	2026-09-24 12:11:53.814282+00	Chris Prather	chris.prather@tamarou.com	2026-03-30 06:56:54+00	Chris Prather	chris.prather@tamarou.com
deploy	c0834addb5a970c41dc185be91f226cba562e013	tenant-domains	registry	Custom domain management for tenants	{notifications-and-preferences}	{}	{}	2026-09-24 12:11:54.018959+00	Chris Prather	chris.prather@tamarou.com	2026-03-30 19:04:42+00	Chris Prather	chris.prather@tamarou.com
deploy	5656344b5447eb9e8d5b274f18d9fbfffa20f8d4	magic-link-verification	registry	Add verified_at column for two-step magic link flow	{passwordless-auth}	{}	{}	2026-09-24 12:11:54.356226+00	Chris Prather	chris.prather@tamarou.com	2026-03-31 12:11:05+00	Chris Prather	chris.prather@tamarou.com
deploy	c3c7ae6599f4db30315a79d7021519f29dafa31d	waitlist-accepted-status	registry	Add accepted status to waitlist check constraint	{waitlist-management}	{}	{}	2026-09-24 12:11:54.607509+00	Chris Prather	chris.prather@tamarou.com	2026-04-05 01:37:21+00	Chris Prather	chris.prather@tamarou.com
deploy	b1024a8fd0df88c3fd8a543fb5a09512b3fa1cfb	seed-registry-storefront	registry	Seed registry tenant storefront (empty stub, deployed to production)	{events-and-sessions}	{}	{}	2026-09-24 12:11:54.841717+00	Chris Prather	chris.prather@tamarou.com	2026-04-07 13:42:30+00	Chris Prather	chris.prather@tamarou.com
deploy	0d0c296e547099f9f75884c8283a0077920abc8c	seed-registry-storefront-v2	registry	Seed registry tenant storefront with actual data	{seed-registry-storefront}	{}	{}	2026-09-24 12:11:55.120977+00	Chris Prather	chris.prather@tamarou.com	2026-04-07 14:44:00+00	Chris Prather	chris.prather@tamarou.com
deploy	3c41efd35c15d993a9e2b9e7621c7f14de92649e	registry-landing-page-template	registry	Customize registry tenant landing page for Jordan's user journey	{seed-registry-storefront-v2}	{}	{}	2026-09-24 12:11:56.130754+00	Chris Prather	chris.prather@tamarou.com	2026-04-11 00:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	730dfd28d76922a358dc3e5eaeb144725df7111e	fix-utf8-mojibake	registry	Delete DB templates with mojibake so app reimports fixed versions	{registry-landing-page-template}	{}	{}	2026-09-24 12:11:56.329078+00	Chris Prather	chris.prather@tamarou.com	2026-04-11 12:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	4a34ed08664b5ae39f7caacd4f663285efb88267	update-registry-landing-copy	registry	Update registry landing page copy and 3x2 card grid	{fix-utf8-mojibake}	{}	{}	2026-09-24 12:11:56.616396+00	Chris Prather	chris.prather@tamarou.com	2026-04-11 14:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	44c65bead55e0a35c5372aa2410a7fe5b3bf0e6b	program-publish-status	registry	Add status to projects and contact_person_id to locations for admin program setup	{summer-camp-module,tenant-domains}	{}	{}	2026-09-24 12:11:56.902253+00	Chris Prather	chris.prather@tamarou.com	2026-04-19 00:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	c2d827c1542f2cf88b9769412919a1ee176147e7	enrollment-confirmation-notification-type	registry	Add enrollment_confirmation notification type	{auth-notification-types}	{}	{}	2026-09-24 12:11:57.379554+00	Chris Prather	chris.prather@tamarou.com	2026-04-23 00:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	d8dd117aea69688b601f189b8a05f2cc9975b897	webhook-event-dedup	registry	Track processed Stripe webhook event IDs for deduplication	{payments}	{}	{}	2026-09-24 12:11:58.313378+00	Chris Prather	chris.prather@tamarou.com	2026-06-01 00:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	bfb052f4957649f0ccf5c59096ee321a100f2886	enrollment-payment-dedup	registry	Unique index to make paid-enrollment finalization idempotent	{add-payment-to-enrollments}	{}	{}	2026-09-24 12:11:59.220038+00	Chris Prather	chris.prather@tamarou.com	2026-06-01 01:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	e9ff0519934e4fcea62f4734c5b9d3b20c09ef4c	fix-attendance-student-id-fkey	registry	Remove student_id FK from attendance_records to allow polymorphic family_member references	{attendance-tracking}	{}	{}	2026-09-24 12:11:59.416891+00	Chris Prather	chris.prather@tamarou.com	2026-06-08 00:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	3c299ff8324976d192be357e48699e64c975784f	fix-clone-schema-identifier-quoting	registry	Quote dest_schema consistently with quote_ident in clone_schema to support reserved-word schema names	{schema-based-multitennancy}	{}	{}	2026-09-24 12:11:59.608905+00	Chris Prather	chris.prather@tamarou.com	2026-06-10 00:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	3207dcbdd391a3113f62367a901b0319137093bc	tenant-stripe-connect	registry	Add per-tenant Stripe Connect account and readiness flags for destination charges	{stripe-subscription-integration}	{}	{}	2026-09-24 12:11:59.795489+00	Chris Prather	chris.prather@tamarou.com	2026-06-10 00:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	28e0bf2c6d92e23110f116d7ec4bd11d3a37c607	tenant-scoped-payments	registry	Move payment tables into tenant schemas and repoint enrollments.payment_id FK for tenant-local payment isolation	{payments,installment-payment-schedules,add-payment-to-enrollments,enrollment-payment-dedup,tenant-stripe-connect}	{}	{}	2026-09-24 12:12:00.006668+00	Chris Prather	chris.prather@tamarou.com	2026-06-10 00:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	28d74506683168469a7f47f7ba0500804400ebeb	seed-free-platform-plan	registry	Seed platform-scope Free (0%) fallback plan	{unified-pricing-infrastructure}	{}	{}	2026-09-24 12:12:00.34031+00	Chris Prather	chris.prather@tamarou.com	2026-06-13 00:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	ab661862f6c5f4126610587fd3e7da46123c2f04	create-default-pricing-relationships	registry	Create active platform relationships so tenant plans are selectable	{remove-pricing-plan-relationship-fields,unified-pricing-infrastructure,seed-free-platform-plan}	{}	{}	2026-09-24 12:12:01.221537+00	Chris Prather	chris.prather@tamarou.com	2026-06-13 00:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	a3a7d4de067885cf24f3b965cee829661b4e7c63	tenant-platform-pricing-plan	registry	Add tenants.platform_pricing_plan_id FK and backfill existing tenants	{create-default-pricing-relationships}	{}	{}	2026-09-24 12:12:01.857637+00	Chris Prather	chris.prather@tamarou.com	2026-06-16 00:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	4f5c0e1ad6352f2a79bd35ab6532bea463f381dc	refund-application-fee-config	registry	Declare refund_application_fee on seeded platform + tenant plans	{seed-free-platform-plan}	{}	{}	2026-09-24 12:12:02.132127+00	Chris Prather	chris.prather@tamarou.com	2026-07-03 23:09:47+00	Chris Prather	chris.prather@tamarou.com
deploy	f2e5326eff1970535911be0d1222e035d521c000	suspend-rateless-tenant-plans	registry	Stop offering tenant plans with no resolvable revenue-share rate	{create-default-pricing-relationships}	{}	{}	2026-09-24 12:12:02.359781+00	Chris Prather	chris.prather@tamarou.com	2026-08-03 23:18:43+00	Chris Prather	chris.prather@tamarou.com
deploy	0efcbdec112780d02871150d379f0e2b07264241	pricing-plans-amount-cents	registry	Store pricing_plans money as integer cents; the rate lives only in pricing_configuration	{suspend-rateless-tenant-plans}	{}	{}	2026-09-24 12:12:02.578894+00	Chris Prather	chris.prather@tamarou.com	2026-08-06 00:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	d685f3eb74071b32ce295c7722ef57a33c66f5d5	payments-amount-cents	registry	Store payments and payment_items money as integer cents	{pricing-plans-amount-cents}	{}	{}	2026-09-24 12:12:02.814389+00	Chris Prather	chris.prather@tamarou.com	2026-08-06 12:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	723b2c3e0164207d1f004b5584857c3f892cb0cc	schedule-amounts-cents	registry	Store installment schedule money as integer cents	{payments-amount-cents}	{}	{}	2026-09-24 12:12:03.007561+00	Chris Prather	chris.prather@tamarou.com	2026-08-06 13:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	7299cb40a004b6904fadeecd2da45cb01f18da03	refund-amounts-cents	registry	Store refund money as integer cents	{schedule-amounts-cents}	{}	{}	2026-09-24 12:12:03.315086+00	Chris Prather	chris.prather@tamarou.com	2026-08-06 14:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	1e944e76794f6455bcc241ac32a0cf7ad80786f0	drop-installment-schedules	registry	Drop the installment schedule tables from registry and every tenant schema	{schedule-amounts-cents,tenant-scoped-payments}	{}	{}	2026-09-24 12:12:03.898768+00	Chris Prather	chris.prather@tamarou.com	2026-08-13 13:50:16+00	Chris Prather	chris.prather@tamarou.com
deploy	124e93eb6de0fd73c5506f9d21d246c748f42f60	retire-registry-plus-plan	registry	Stop offering the seeded Registry Plus hybrid plan	{suspend-rateless-tenant-plans}	{}	{}	2026-09-24 12:12:04.828153+00	Chris Prather	chris.prather@tamarou.com	2026-08-13 14:37:13+00	Chris Prather	chris.prather@tamarou.com
deploy	51493d6426abe6800146664a09dd14c4845ef24c	webhook-events-processed-at	registry	Add processed_at to registry.webhook_events for received-to-processed latency	{webhook-event-dedup}	{}	{}	2026-09-24 12:12:05.625425+00	Chris Prather	chris.prather@tamarou.com	2026-08-15 14:37:28+00	Chris Prather	chris.prather@tamarou.com
deploy	38dbe5f9ef7655079f93ab63a547b6ae7ea6c022	payments-typed-obligation	registry	Typed columns for the capacity-refund obligation, and a CHECK on payments.status	{refund-amounts-cents}	{}	{}	2026-09-24 12:12:06.161852+00	Chris Prather	chris.prather@tamarou.com	2026-08-22 23:30:00+00	Chris Prather	chris.prather@tamarou.com
deploy	cd225459045762634487962815fd105ace1caf30	enrollment-reenrol-after-drop	registry	A cancelled enrollment stops occupying its seat, so a dropped child can re-join	{flexible-enrollment-architecture}	{}	{}	2026-09-24 12:12:06.879242+00	Chris Prather	chris.prather@tamarou.com	2026-08-26 22:00:00+00	Chris Prather	chris.prather@tamarou.com
deploy	4f4968a7059d18a3163416e0754cd69981058282	set-launch-revenue-share-rate	registry	Move the offered revenue-share plan to the launch rate and mark it as the launch plan	{retire-registry-plus-plan}	{}	{}	2026-09-24 12:12:07.303207+00	Chris Prather	chris.prather@tamarou.com	2026-09-04 14:50:00+00	Chris Prather	chris.prather@tamarou.com
deploy	49f1934e333630282a31ceaf6eeb71898b27d9c5	seed-tier-pricing-options	registry	Put the Solo/Studio/Empire tier model into the plans the signup page renders	{set-launch-revenue-share-rate}	{}	{}	2026-09-24 12:12:07.674083+00	Chris Prather	chris.prather@tamarou.com	2026-09-04 16:05:00+00	Chris Prather	chris.prather@tamarou.com
deploy	0f7d16835c8b41ad227ab66d68c36003de68fc21	clear-template-import-stamps	registry	Drop stamps computed from bytes so the fixed character-based import re-stamps every row	{seed-tier-pricing-options}	{}	{}	2026-09-24 12:12:07.974532+00	Chris Prather	chris.prather@tamarou.com	2026-09-13 21:15:00+00	Chris Prather	chris.prather@tamarou.com
deploy	20680f8b72d460b535289c226047d46b15a1a499	tenant-slug-lowercase	registry	Tenant slugs must be lowercase: clone_schema case-folds an unquoted dest_schema	{clear-template-import-stamps}	{}	{}	2026-09-24 12:12:08.250331+00	Chris Prather	chris.prather@tamarou.com	2026-09-14 04:05:00+00	Chris Prather	chris.prather@tamarou.com
deploy	a7040f956947ab1eaa9b1eb52dac77c768d24082	session-waitlist-toggle	registry	A session can turn its waitlist off, so a full one is simply full	{tenant-slug-lowercase}	{}	{}	2026-09-24 12:12:08.510725+00	Chris Prather	chris.prather@tamarou.com	2026-09-24 12:10:00+00	Chris Prather	chris.prather@tamarou.com
\.
...
registry	\N	2026-09-24 12:11:38.005542+00	Chris Prather	chris.prather@tamarou.com
\.
...
1.1	2026-09-24 12:11:37.998171+00	Chris Prather	chris.prather@tamarou.com
\.
...
--
-- Name: webhook_events webhook_events_pkey; Type: CONSTRAINT; Schema: registry; Owner: postgres
--

ALTER TABLE ONLY registry.webhook_events
    ADD CONSTRAINT webhook_events_pkey PRIMARY KEY (id);


--
-- Name: webhook_events webhook_events_stripe_event_id_key; Type: CONSTRAINT; Schema: registry; Owner: postgres
--
...
--
-- Name: enrollments_payment_dedup; Type: INDEX; Schema: registry; Owner: postgres
--

CREATE UNIQUE INDEX enrollments_payment_dedup ON registry.enrollments USING btree (session_id, student_id, payment_id) WHERE (payment_id IS NOT NULL);


--
-- Name: enrollments_session_student_type_live; Type: INDEX; Schema: registry; Owner: postgres
--

CREATE UNIQUE INDEX enrollments_session_student_type_live ON registry.enrollments USING btree (session_id, student_id, student_type) WHERE (status IS DISTINCT FROM 'cancelled'::text);
...
--
-- Name: idx_payments_refund_owed; Type: INDEX; Schema: registry; Owner: postgres
--

CREATE INDEX idx_payments_refund_owed ON registry.payments USING btree (refund_owed_cents) WHERE (refund_owed_cents > 0);
...
--
-- Name: tenants tenants_platform_pricing_plan_id_fkey; Type: FK CONSTRAINT; Schema: registry; Owner: postgres
--

ALTER TABLE ONLY registry.tenants
    ADD CONSTRAINT tenants_platform_pricing_plan_id_fkey FOREIGN KEY (platform_pricing_plan_id) REFERENCES registry.pricing_plans(id);
